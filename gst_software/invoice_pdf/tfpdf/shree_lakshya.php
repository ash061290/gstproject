...
/*
	...
	*/
	...
	$this->SetTextColor(1,8,21);
	//$this->SetLineWidth(0.150);
    $this->Cell(70,4,'Address:'.$invoice_billing_address1,0);
    $this->Cell(85,4,'',0);
    $this->Cell(55,4,'Address:'.$invoice_shipping_address1,0);
    $this->Ln();
		
	$this->Cell(70,4,'              '.$invoice_billing_address2,0);
    $this->Cell(85,4,'',0);
    $this->Cell(55,4,'              '.$invoice_shipping_address2,0);
    $this->Ln();
	//end
	$this->SetFont('Times','',11);
	$this->SetTextColor(1,8,21);
	...
	$this->SetTextColor(1,8,21);
	//$this->SetLineWidth(0.150);
    $this->Cell(70,4,'PanCard:'.$contact_pan,0);
	 $this->Cell(85,1,'',0);
	...
	$this->SetTextColor(1,8,21);
	//$this->SetLineWidth(0.150);
    $this->Cell(70,4,'AdharCard:'.$contact_adhar,0);
	$this->Cell(85,1,'',0);
    ...
    $this->Cell(18,15,''.$invoice_tax,1,0,'C');
    $this->Cell(10,15,''.$invoice_cgst,1,0,'C');
    $this->Cell(10,15,''.$cgst_total,1,0,'C');
    $this->Cell(10,15,''.$invoice_sgst,1,0,'C');
    $this->Cell(10,15,''.$sgst_total,1,0,'C');
    $this->Cell(10,15,''.$invoice_igst,1,0,'C');
    $this->Cell(10,15,''.$igst_total,1,0,'C');
    $this->Ln();
	...
	$this->Cell(190,7,'Total Taxable Value:',0);
    $this->Ln();
	$this->Cell(211,7,' Companys Bank Details',0);

...
global $invoice_no,$invoice_date;
...
$invoice_date=$invoice_date1[2].'/'.$invoice_date1[1].'/'.$invoice_date1[0];
	...
	$this->Image('apple.png',2,1,30,30);
	$this->Ln();
    ...
    $this->Cell(190,8,'Tax Invoice No. : '.$invoice_no,0);
	$this->Ln();
	$this->SetXY(230,15); 
    $this->SetFont('Times','',12);
	$this->Cell(190,8,'Date                    : '.$invoice_date,0);
	$this->Ln();
	$this->SetXY(230,20); 
    $this->SetFont('Times','',12);
    $this->Cell(190,8,'SE Name            :',0);
	$this->Ln();
	$this->SetXY(230,25); 
    $this->SetFont('Times','',12);
	$this->Cell(190,8,'Att Name            :',0);
	$this->Ln(); 
...
function Footer()
{
global $invoice_cgst,$invoice_sgst,$invoice_igst,$total_tax,$invoice_grand_total,$invoice_terms_and_conditions;
...
$number = $invoice_grand_total;
  ...
  $points = ($point) ?
    ...
    $this->SetTextColor(0,0,128);
    $this->Cell(240,8,'Amount In Words: '.$result."Rupees Only",0,0,'L');
    $this->Ln();
    ...
    $this->SetFont('Times','',10);
    $this->SetTextColor(26,26,28);
    $this->Cell(190,8,'SGST :'.$invoice_sgst,0);
    $this->Ln(); 
	
	$this->SetXY(228,170); 
    $this->SetFont('Times','',10);
    $this->SetTextColor(26,26,28);
    $this->Cell(190,8,'IGST  :'.$invoice_igst,0);
    $this->Ln(); 
    ...
    $this->SetFont('Times','',10);
    $this->SetTextColor(26,26,28);
    $this->Cell(190,8,'Total Value Of Supply :'.$total_tax,0);
    $this->Ln();
...
function Table1()
{
global $invoice_grand_total,$contact_tittle_name,$contact_first_name,$contact_last_name,$contact_company_name,$invoice_gstin_no,$invoice_billing_address,$invoice_shipping_address,$invoice_place_of_supply,$remark;
    ...
    $this->Cell(55,4,'                                                                           Address : '.$invoice_shipping_address.' '.$invoice_place_of_supply,0);
    $this->Ln();
	...
	$this->SetTextColor(1,8,21);
	//$this->SetLineWidth(0.150);
    $this->Cell(70,4,'State : ',0);
    $this->Cell(55,4,'                                                                           GSTIN : '.$invoice_gstin_no,0);
    $this->Ln();
    ...
    $this->Cell(91,15,''.$invoice_description,1,0,'C');
    ...
    $this->Cell(16,10,' '.$invoice_grand_total,0,0,'L');

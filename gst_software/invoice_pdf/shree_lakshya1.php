...
function Header()
{
    ...
    $this->SetFont('Times','',12);
    $this->SetTextColor(0,0,128);
    $this->Cell(190,8,'Tax Invoice No. : 4316813',0);
	$this->Ln();
	$this->SetXY(230,39); 
    $this->SetFont('Times','',12);
	$this->Cell(190,8,'Date                    : 24/05/2018',0);
	$this->Ln();
	$this->SetXY(230,44); 
    $this->SetFont('Times','',12);
...
function Table1()
{
	...
	$this->SetTextColor(1,8,21);
	//$this->SetLineWidth(0.150);
    $this->Cell(70,4,'Name:',0);
    $this->Cell(55,4,'                                                                                        Name: ',0);
    $this->Ln();
    
	$this->SetFont('Times','',11);
	$this->SetTextColor(1,8,21);
	//$this->SetLineWidth(0.150);
    $this->Cell(70,4,'Owner Name:',0);
    $this->Cell(55,4,'                                                                                        Owner Name: ',0);
    $this->Ln();
	
	$this->SetFont('Times','',11);
	$this->SetTextColor(1,8,21);
	//$this->SetLineWidth(0.150);
    $this->Cell(70,4,'Address:',0);
    $this->Cell(55,4,'                                                                                        Address: ',0);
    $this->Ln();

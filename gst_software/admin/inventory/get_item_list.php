...
$que="select * from item_master where item_status='Active' and item_group='$item_group' and item_sub_group='$item_sub_group' LIMIT $pageLimit , $setLimit ";

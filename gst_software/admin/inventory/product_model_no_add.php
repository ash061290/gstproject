...
$("#my_form").submit(function(e){
    ...
    var formdata = new FormData(this);
        ...
        $.ajax({
            ...
            url: software_link+"inventory/product_model_no_add_api.php",
            type: "POST",
            data: formdata,
...
function delete_product_model_no(s_no){  
$.ajax({
type: "POST",
url: software_link+"inventory/product_model_no_delete_api.php",
data: "id="+s_no,
cache: false,
    ...
    <div class="box my_border_top">
        <div class="box-body">
			<form role="form" id="my_form" enctype="multipart/form-data">	
				...
				<tr>
          <td class="col-md-4">
           <select name="brand_name" class="form-control select2" id="brand" width="100%"  onchange="category_select(this.value)" required="true">  
		  ...
		  <td class="col-md-4">
		  	<select class="form-control" name="subcategory_name" id="subcategory_names" required>
				...
				<tr>
				<td colspan="3"><input type="submit" name="submit" value="Submit" class="btn btn-success" /></td>
					</tr>				
				</tbody>
          ...
          <th>Brand Name</th>
				...
				<th>
				 <a href="#" >Active</a>&nbsp;&nbsp;&nbsp;&nbsp;
				 <a href="javascript:post_content('inventory/product_model_no_edit','<?php echo 'id='.$s_no; ?>')" ><i class="fa fa-edit" style="font-size:18px;" ></i></a>
				 &nbsp;&nbsp;&nbsp;&nbsp;

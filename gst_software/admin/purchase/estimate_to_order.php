  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-plus"></i> Create Order</a></li>
      </ol>
    </section>
<!---*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************-->
	<?php
	...
	while($row11=mysql_fetch_array($run11)){
			$s_no=$row11['s_no'];
			$invoice_estimate_no=$row11['invoice_no'];
			...
			$invoice_place_of_supply=$row11['invoice_place_of_supply'];
			 $purchase_person_name = $row11['sales_person_name'];
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
	<div class="box-body">
				<div class="col-md-12 ">	
						...
						?>
						  <label>Order No.</label>
						   <input type="text" name="invoice_no" placeholder="" value="<?php if($estimate_type=='sales'){ echo 'SO-'.$val; }elseif($estimate_type=='purchase'){ echo 'PO-'.$val; } ?>" class="form-control" readonly>
						</div>
				</div>
				<div class="col-md-12 ">				
					<div class="form-group col-md-5" >
				...
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >
					  ...
					  <input type="text" name="purchase_person_name" value="<?php echo $purchase_person_name; ?>" placeholder="Purchase Person Name" class="form-control">
					</div>
				</div>
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >
					  <label>Purchase Excutive Name</label>
					  <input type="text" name="purchase_excutive_name" value="" placeholder="Purchase Excutive Name" class="form-control" required>
					</div>
				</div>
    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered" style="background-color:white;">
			...
			<tbody>
			<?php
			if($number==0){$table_name = "purchase_estimate_info";} else{ $table_name="purchase_estimate_draft_info"; }
...
$purchase_excutive_name = $_POST['purchase_excutive_name'];

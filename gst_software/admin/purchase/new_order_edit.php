	...
	<div class="box-body">
				...
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >
					  ...
					  <input type="tax" name="delivery_method" placeholder="Delivery Method" class="form-control">
					</div>
				</div>
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >

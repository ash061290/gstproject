...
<?php
     ...
     if(isset($_GET['from_date']))
	 {
		...
		$qry ="SELECT * FROM purchase_invoice_info where invoice_status='Active' AND invoice_date >= '$from_date' AND invoice_date <= '$to_date' and company_code='$company_code' GROUP BY invoice_no";
...
<tr  align='center' >
    ...
    <th>
	<a style="color:Red;" aria-hidden="true" onclick="return myFunction()" class="fa fa-trash-o" href='purchase_payment_delete.php?invoice_id=<?php echo $invoice_no; ?>'> Delete</a></th>
</tr>
<?php  $serial_no++; } ?>
<?php
		}

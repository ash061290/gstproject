...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	if(id!=''){
	window.open('../contact/contact_edit.php?id='+id+'&page1=new_estimate','_self');
	}else{
	...
	window.open('new_estimate.php?inv_type='+value,'_self');
	}
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="javascript:post_content('purchase/purchase_estimate_list','inv_type=sales')"><i class="fa fa-shopping-cart"></i>Purchase Estimate</a></li>
	...
	<div class="box-body">
	           <div class="col-md-12">
		         ...
		         <div class="col-md-12 ">				
					...
					<br><br>
					<a href="javascript:post_content('contact/contact','inv_type=sales')"><button type="button" style="background-color:#00a65a; color:white" class="">+ New Contact</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				$sales_estimate_draft_no=$row2['sales_estimate_draft_no'];
				$val=substr($sales_estimate_no, 1);
				 }
				 if($inv_type == 'purchase'){
				$purchase_estimate_no=$row2['purchase_estimate_no'];
				$val=substr($purchase_estimate_no, 1);
				 }
				...
				<div class="form-group col-md-5">
				  <label>Estimate No.</label>
				   <input type="text" name="invoice_no" placeholder="" value="<?php echo 'EST-'.$val; ?>" class="form-control" readonly>
				</div>
				</div>
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >
			...
			<div class="col-md-3 ">		
						<div class="form-group">
						  <label>Customer Notes</label>
						   <textarea name="invoice_customer_notes" id="invoice_customer_notes" rows="5" cols="200" style="width:250px" class="form-control"></textarea>
						</div>
			</div>
			</div>
...
$table_name='sales_estimate_draft_info';
$page_name='sales_estimate_list.php';
$transaction_type='Credit';
}elseif($invoice_type=='purchase'){
$table_name='purchase_estimate_draft_info';

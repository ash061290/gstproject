...
<script src="search_script.js"></script>
  ...
  function item_desc(value,sno,company_code){
	if(value == ''){
			...
			$("#for_desc_"+sno).hide();
			$("#hsn_"+sno).hide();
			$("#abl_quantity_"+sno).hide();
			$("#unit_"+sno).hide();
			$("#for_abl_quantity_"+sno).hide();
			$("#for_unit_"+sno).hide();
			$("#for_cgst_"+sno).hide();
			$("#for_sgst_"+sno).hide();
			$("#for_igst_"+sno).hide();
...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	if(id!=''){
	window.open('../contact/contact_edit.php?id='+id+'&page1=new_order','_self');
	}else{
	...
	window.open('new_order.php?inv_type='+value,'_self');
	}
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="javascript:post_content('purchase/purchase_order_list','inv_type=sales')"><i class="fa fa-shopping-cart"></i>Purchase order</a></li>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title" style="color:red">Order</h1>
            </div>
	<div class="box-body">
				...
				<div class="col-md-12">				
					<div class="form-group col-md-5" >
					  ...
					  <option value="">Select Firm</option>
					        <?php
							$qry="select * from contact_master where contact_status='Active' and company_code='$company_code' and contact_contact_type='Vendor'";
				...
				<div class="col-md-12">
						...
						$purchase_order_no=$row2['purchase_order_no'];
						$val=substr($purchase_order_no, 1);
						}
						?>
						<div class="form-group col-md-5">
						  <label>Order No.</label>
						   <input type="text" name="invoice_no" id="invoice_no" placeholder="" value="<?php if(isset($_GET['inv_type'])){ if($inv_type=='sales'){ echo 'SO-'.$val; }elseif($inv_type=='purchase'){ echo 'PO-'.$val; } }else{ echo 'SO-'.$val; } ?>" class="form-control" readonly>
						</div>
				</div>
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >
				...
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >
					  ...
					  <input type="tax" name="sales_person_name" placeholder="Sales Person Name" class="form-control">
					</div>
				</div>
				<div class="col-md-12 ">	
					<div class="form-group col-md-5" >
					  <label>Sales Excutive Name</label>
					  <input type="tax" name="sales_excutive_name" placeholder="Sales Excutive Name"  class="form-control">
					</div>
				</div>
	...
	<input type="hidden" id="sample2" value="1" />
        <table class="table table-bordered" style="background-color:white;">
			...
			<tr>    
					...
					<div class="col-md-12">
					 <div class="row">
						<label id="for_cgst_1" style="display:none;font-size:12px;color:#423C9B;">CGST : </label>
						...
						<label id="for_sgst_1" style="display:none;font-size:12px;color:#423C9B;">SGST : </label>
						...
						<label id="for_igst_1" style="display:none;font-size:12px;color:#423C9B;">IGST : </label>
		...
		<br>
			...
			<div class="box-footer">
					...
					<div class="col-md-2">
					<div class="form-group" >
						<input type="submit"  name="save_as_draft" value="Save as Draft" class="form-control btn-default">
					</div>
					</div>
					...
					<div class="col-md-2">
					<div class="form-group" >
						<input type="submit"  name="save_and_send" value="Save and Send" class="form-control btn-default">
					</div>
					</div>
					<div class="col-md-2">
					<div class="form-group" >
...
$table_name='sales_order_draft_info';
$page_name='sales_order_draft_list.php';
$transaction_type='Credit';
}elseif($invoice_type=='purchase'){
$table_name='purchase_order_draft_info';

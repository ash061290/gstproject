    ...
    var formdata = new FormData(this);
        $.ajax({
            ...
            success: function(detail){
               var res=detail.split("|?|");
			   if(res[1]=='success'){
	    post_content('purchase/new_invoice',res[2]);
  ...
  $query2="select * from invoice_no where company_code='$company_code'";
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:post_content('purchase/purchase_invoice_list','inv_type=purchase')"></i>Purchase Invoice</a></li>
              ...
              <div class="col-md-12">
				...
				<div class="col-md-12 ">				
					<div class="form-group col-md-4" >
						...
						<textarea name="invoice_billing_address" id="invoice_billing_address" rows="2" class="form-control" style="resize:none;"></textarea>
					</div>			
					<div class="form-group col-md-4" >
			 ...
			 <tr>
					...
					<td>
					  <div class="form-group">
							...
							<option value=''>Select</option>
							<?php
							$query="select item_product_name,s_no from item where item_status='Active' and company_code='$company_code'";
				...
				<div class="col-md-4">
					<div class="form-group">
					 <label> Payment Mode</label>
						...
						<option value="">Select</option>
						<?php
						$query4="select * from bank_or_credit_card_info where bank_status='Active' and account_type='Purchase Account' or bank_account_name='Petty Cash' or bank_account_name='Undeposited Funds' or account_type='E-payment Account' and company_code='$company_code'";

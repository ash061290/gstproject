...
$que12="SELECT * FROM sales_invoice_info WHERE order_status='Cancel' AND invoice_status='Active' AND invoice_date >= '$from_date' AND invoice_date <= '$to_date' GROUP BY invoice_no ORDER BY invoice_date DESC";

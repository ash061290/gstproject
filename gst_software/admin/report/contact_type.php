...
<?php if(isset($_GET['contact_type']))
{
  ...
  ?>
    ...
    <section class="content-header">
      <h1>
      Contact Types Payment
	   <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-home"></i>Home</a></li>
		<li><a href="javascript:get_content('reminder/receivable')"><i class="fa fa-list"></i>Receivable Payment</a></li>
        <li><a href="javascript:get_content('reminder/payable_payment')"><i class="fa fa-list"></i>Payable Payment</a></li>
		<li><a href="javascript:get_content('reminder/Default')"><i class="fa fa-list"></i>Default Payment</a></li>
...
<script>
   ...
   else
   {
		 $.ajax({
             type:"POST",		   
		     url: software_link+"reminder/ajax_search.php?pay_term="+pay_term+"&contact_type="+contact_type+"",
			 cache:false,
...
<script type="text/javascript">
	  ...
	  var to_date= document.getElementById('to_date').value;
	   ...
	   $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_search.php?from_date="+from_date+"&to_date="+to_date+"&contact_type="+contact_type+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
	    ...
	    if(current_month=="all")
   {
    ...
    var to_date=current_year+'-12-31';
      $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_search.php?current_year="+current_year+"&contact_type="+contact_type+"&from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
...
<script type="text/javascript">
	...
	<input type="hidden" id="contact_type" value="<?php echo $contact_type; ?>">
    <div class="row">
	<div class="col-sm-12">
	    <div class="box">
	        <div class="col-md-12">	
 ...
 <select name="contact_payment_terms" class="form-control" onchange="pay_term(this.value)" style="width:100%">

...
<!--end firm-->	
	...
	$("#sales_advance_to_invoice_form").submit(function(e){
        e.preventDefault();
    var formdata = new FormData(this);
        $.ajax({
            url: software_link+"advance_pay/ajax_sales_advance_to_invoice_submit.php",
            type: "POST",
            data: formdata,
  ...
  <!-- Content Wrapper. Contains page content -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index.php')"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="javascript:get_content('advance_pay/new_invoice')"><i class="fa fa-plus"></i> Add Invoice</a></li>
	...
	$que11="select * from $table_name where invoice_no='$advance_no' and invoice_status='Active'";
	...
	?>
    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="sales_advance_to_invoice_form" enctype="multipart/form-data">
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered" style="background-color:white;">
			...
			<tbody>
			<?php
			$que12="select * from $table_name where invoice_no='$advance_no' and invoice_status='Active'";

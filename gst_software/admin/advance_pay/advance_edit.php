...
<?php if(isset($_GET['id']))
{
  ...
  $.ajax({
			address: "POST",
			url: software_link+"advance_pay/ajax_get_item_description.php?value="+value+"&inv_type="+inv_type+"",
			cache: false,
  ...
  function firm_info(value){
		$.ajax({
			address: "POST",
			url: software_link+"advance_pay/get_firm_details.php?id="+value+"",
			cache: false,
			success: function(detail){
			var res = detail.split("|?|");
  ...
  <!-- Content Wrapper. Contains page content -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="add_payment.php"><i class="fa fa-shopping-cart"></i>Add Invoice</a></li>
        <li class="active">Advance Invoice</li>
      </ol>
    </section><!---*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************-->
    <!-- Main content -->
	<?php
	$que11="select * from sales_invoice_info where invoice_no='$id' and invoice_status='Active' and company_code='$company_code'";
...
<!------------------------------------------------Start Registration form---------------------------------------------------->
	<div class="box-body">
				<div class="col-lg-12">
		<?php		$query2="select advance_invoice_no from invoice_no where company_code='$company_code'";
				...
				<div class="col-lg-12">
					<div class="form-group col-lg-5">
					 <label>Advance Payment Date</label>
					  <input type="date" name="payment_date" placeholder="Date" value="<?php echo $invoice_date; ?>" class="form-control">
					</div>
				</div>
				<div class="col-lg-12">
					<div class="form-group col-lg-5">
				...
				<div class="col-lg-12">
					<div class="form-group col-lg-5">
					 ...
					 <input type="date" name="delivery_date" placeholder="Date" value="<?php echo $invoice_due_date; ?>" class="form-control">
					</div>
				</div>		
	</div>
	</div>
    ...
    <div class="box-body table-responsive">
        <table id="item_table" class="table table-bordered" style="background-color:white;">
			...
			<tbody>
			<?php
			$que12="select * from sales_invoice_info where invoice_no='$invoice_no' and invoice_status='Active' and company_code='$company_code'";
			$run12=mysql_query($que12) or die(mysql_error());
			$serial=0;
				...
				<td><span id='<?php echo 'snum_'.$serial; ?>' class="snm"><?php echo $serial.'.'; ?></span><input type="hidden" name="invoice_s_no[]" id="<?php echo 'invoice_s_no_'.$serial; ?>" value="<?php echo $invoice_s_no; ?>" /></td>
					...
					<td>
					 <div class="form-group">
							...
							<?php
							$query="select * from item_master and company_code='$company_code'";
			...
			<div class="col-md-3 ">		
						<div class="form-group">
						  <label>Customer Notes</label>
						   <textarea name="invoice_customer_notes" id="invoice_customer_notes" rows="5" cols="200" style="width:300px" class="form-control"><?php echo $invoice_customer_notes; ?></textarea>
						</div>
			</div>
			</div>

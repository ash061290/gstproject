<?php include("../../attachment/session.php");?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li><a href="javascript:get_content('due_payment/defaulter')"><i class="fa fa-list"></i>Default Payment</a></li>
...
<script type="text/javascript">
	  ...
	  $.ajax({
			  type: "POST",
              url: software_link+"due_payment/ajax_due_payment_date.php?credit_from_date="+from_date+"&credit_to_date="+to_date+"",
              cache: false,
	  ...
	  if(current_month =='all')
   {
      ...
      $.ajax({
			  type: "POST",
              url: software_link+"due_payment/ajax_due_payment_all_month.php?credit_current_year="+current_year+"&from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
...
//ashish create
   ...
   else
   {
		 $.ajax({
             type:"POST",		   
		     url: software_link+"due_payment/ajax_payterm_search.php?pay_term_credit="+pay_term+"",
			 cache:false,

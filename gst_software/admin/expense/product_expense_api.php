...
for($i=0; $i<$count; $i++){
echo $query="insert into expense_new(expense_no,expense_date,expense_contact_no,expense_product_name,expense_quantity,expense_price,expense_total_amount,expense_item_description,expense_payment_mode,expense_total_paid,expense_due_amount,expense_terms_and_conditions,expense_customer_notes,expense_sub_total,expense_grand_total,product_expense_type,expense_type,expense_status,company_code)values('$expense_no','$expense_date','$expense_contact_no','$expense_product_name[$i]','$expense_quantity[$i]','$expense_price[$i]','$expense_total_amount[$i]','$expense_item_description','$expense_payment_mode','$expense_total_paid','$expense_due_amount','$expense_terms_and_conditions','$expense_customer_notes','$expense_sub_total','$expense_total_paid','$product_expense_type','$expense_type','Active','$company_code')";

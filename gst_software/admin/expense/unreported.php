<?php include("../../attachment/session.php"); ?>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="view_expenses.php"><i class="fa fa-plus"></i>Expenses</a></li>
      ...
      <div class="row">
        ...
        <div class="box">
            ...
            <tbody>
			   <?php
			   $report_name ="";
$que1="SELECT * FROM `add_expense` WHERE `report_id`=''";
...
<th><a href='expenses_report.php?expenses_id=<?php echo $row1['id']; ?>' title="Details" style="color:#AC5B18;"><?php if($expense_status == '1' && $report_id == ''){ echo "UNREPORTED";}  if($expense_status == '1' && $report_id !='' ){ echo "UNSUBMITTED";} 
...
<?php } ?>
  ...
  <?php   $qry ="select * from add_report where title ='$report_name'";

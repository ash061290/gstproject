      ...
      <div class="row">
        ...
        <div class="box">
            ...
            <tbody>
			   <?php
			   $report_name="";
	$que1="SELECT * FROM `add_expense` WHERE `expense_status`='1' AND `report_id`!=''";
...
<th><a href='expenses_report.php?expenses_id=<?php echo $row1['id']; ?>' title="Details"><?php echo "UNSUBMITTED";?></a></th>					

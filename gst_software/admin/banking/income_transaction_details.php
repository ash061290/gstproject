  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Income Transaction Details</li>
      </ol>
    </section>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
		...
		<form role="form" method="post" enctype="multipart/form-data">				
			...
			<div class="col-sm-4" style="margin-left:55px">			
				...
				<?php				
				$que="select * from account_info where bank_s_no='$s_no' and transaction_type='Credit' and account_status='Active' and company_code='$company_code'";
				$run=mysql_query($que);
				while($row=mysql_fetch_array($run)){
          ...
          <!--------------------------------###########################------------------------------------------->	        			
			    ...
			    <div class="col-sm-12 form-horizontal">	
                    ...
                    <div class="col-sm-7">
                      <select class="form-control select2" name="payment_mode" onchange="payment_detail(this.value)" required>
					  <option value="">Select</option>
                    ...
                    <div class="col-sm-7">
                      <select class="form-control select2" name="cheque_or_dd">
					  <option value="">Select</option>
					  <option value="Cheque">Cheque</option>
					  <option value="DD">DD</option>
					  </select>
...
<?php
    ...
    values('$s_no','$customer_id','$date','$invoice_total_paid','$reference','$payment_mode','$cheque_dd','$cheque_dd_no','$cheque_dd_issue_date','$cheque_dd_clearing_date','$remark','Credit','$upload_file','$folder_id','$bank_account_type','$bank_name','$invoice_no','$invoice_balance','$cheque_status','$company_name','$company_code')";

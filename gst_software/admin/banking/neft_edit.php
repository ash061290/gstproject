...
include("../../attachment/session.php");
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit NEFT/RTGS</li>
      </ol>
    </section>
...
<script>
    $("#neft_edit").submit(function(e){
        e.preventDefault();

    var formdata = new FormData(this);

        $.ajax({
            url: software_link+"banking/neft_edit_api.php",
            type: "POST",
            data: formdata,
            ...
            success: function(detail){
			   ...
			   if(res[1]=='success'){
				   ...
				   post_content('banking/neft_details',res[2]);
            }
			}
         });
      });
</script>
<script src="../../assets/js/file_check.js"></script>
 ...
 <section class="content">
    ...
    <div class="box my_border_top">
        ...
        <div class="box-body">
		<form role="form" method="post" id="neft_edit" enctype="multipart/form-data">
			    ...
			    <div class="col-sm-12 form-horizontal">	
                    <div class="col-sm-12">
					<div class="col-sm-6">
                    <h5 style="color:#873600"><b>Edit NEFT/RTGS</b></h5>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-7">
                      <select class="form-control select2" name="neft_transaction_type" style="width:100%">
        ...
        <div class="col-md-1"> 
	     <img  src="<?php if($upload_file!=''){ echo 'data:image;base64,'.$upload_file; }else{ echo $image_path."Profile.png"; }  ?>" id="show_bill_upload" height="50" width="50" style="margin-top:10px;">
	            ...
	            <input type="hidden" value="<?php echo $account_s_no; ?>" name="account_s_no" />
					...
					<div class="col-sm-3">	
			        <input type="submit" name="Save" value="Save" class="btn btn btn-success"><br/>
		            </div>
					<!--<div class="col-sm-3">	
                     <a href="neft_details.php"><button type="button" class="btn btn-primary">Cancel</button></a>
		            </div>-->
		            </div>	
			    </div>
	            </tbody>				

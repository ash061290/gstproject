...
<script type="text/javascript">
   function for_contact(id,value){
       ...
       $.ajax({
			  type: "POST",
              url: software_link+"banking/ajax_contact_search.php?contact_type="+contact_type1+"&business_type="+business_type1+"",
              cache: false,
...
$.ajax({
type: "POST",
url: software_link+"banking/bank_delete_api.php",
data: "id="+s_no,
cache: false,
success: function(detail){
          ...
          <div class="box">
            ...
            <tbody>
			   <?php
				...
				<th>
			   <a href="javascript:post_content('banking/transaction_details','id=<?php echo $s_no; ?>')" title="Details"><i class="fa fa-eye" style="font-size:18px;" ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="javascript:post_content('banking/bank_edit','id=<?php echo $s_no; ?>')"><i class="fa fa-edit" style="font-size:18px;" ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="#"onclick="valid('<?php echo $s_no;?>');"><i class="fa fa-trash" style="font-size:18px; color:red" ></i></a>
				...
				<th><?php echo $bank_account_type; ?></th>
				<th><?php echo $account_type; ?></th>
				<th><a href="javascript:post_content('banking/transaction_details','id=<?php echo $s_no; ?>')" title="Details"><?php echo $bank_amount; ?></a></th>	
				<th>
				...
				<th><?php echo $bank_account_type; ?></th>
				<th><?php echo $account_type; ?></th>
				<th><a href="javascript:post_content('banking/transaction_details','id=<?php echo $s_no; ?>')" title="Details"><?php echo $credit_card_bank_amount; ?></a></th>	
				<th>
                 <a href="javascript:post_content('banking/transaction_details','id=<?php echo $s_no; ?>')"><i class="fa fa-eye" style="font-size:18px;" ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="javascript:post_content('banking/bank_edit','id=<?php echo $s_no; ?>')"><i class="fa fa-edit" style="font-size:18px;" ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="#"onclick="valid('<?php echo $s_no;?>');"><i class="fa fa-trash" style="font-size:18px; color:red" ></i></a>
				...
				<!-- E-Payment-->
				<?php
				    $que="select * from bank_or_credit_card_info where bank_account_type='E-Payment' and bank_status='Active' and company_code='$company_code'";
					$run=mysql_query($que);
					while($row=mysql_fetch_array($run)){
					$s_no = $row['s_no'];
					$bank_account_type = $row['bank_account_type'];

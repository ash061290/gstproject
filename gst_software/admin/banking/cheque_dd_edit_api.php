...
include("../../attachment/image_compression_upload.php");
	...
	$quer="update account_info set bank_s_no='$bank_s_no',customer_id='$customer_id',date='$date',invoice_total_paid='$invoice_total_paid',reference='$reference',payment_mode='$cheque_dd',cheque_dd='$cheque_dd',cheque_dd_no='$cheque_dd_no',cheque_dd_issue_date='$cheque_dd_issue_date',cheque_dd_clearing_date='$cheque_dd_clearing_date',remark='$remark',transaction_type='$cheque_transaction_type',folder_name='',account_type='$bank_account_type',account_name='$bank_name',invoice_no='$invoice_no',invoice_due_amount='$invoice_balance' where s_no='$s_no'";
	
	if($cheque_transaction_type=='Credit'){

...
<!------------------------------------------------Start Registration form--------------------------------------------------->
		...
		<form role="form" method="post" enctype="multipart/form-data">				
			...
			<div class="col-sm-4" style="margin-left:55px">			
				...
				<?php				
				$que="select * from account_info where bank_s_no='$s_no' and transaction_type='Credit' and account_status='Active' and s_no='$account_s_no' and company_code='$company_code'";
				$run=mysql_query($que);
				while($row=mysql_fetch_array($run)){
				...
				<tr>
				  ...
				  <th><a style="color:Green;" class="fa fa-pencil" title="Edit" href='income_transaction_edit.php?id=<?php echo $s_no; ?>&account_s_no=<?php echo $account_s_no;?>'></a>&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:Red;" title="Delete" onclick="return myFunction()" class="fa fa-times" href='income_transaction_delete.php?id=<?php echo $s_no;?>&account_s_no=<?php echo $account_s_no;?>&invoice_no=<?php echo $invoice_no;?>&transaction_type=<?php echo $transaction_type;?>&paid_amount=<?php echo $invoice_total_paid;?>'></a>
				  </th>
				  <?php } } ?>
				</tr>					
				</tbody>
			    ...
			    <div class="col-sm-12 form-horizontal">	
                    <div class="col-sm-12">
					<div class="col-sm-6">
                    <h5 style="color:#2E8B9E"><b>Income</b></h5>
                    </div>
				    <div class="col-sm-6">
                    <a href="income_transaction_details.php?id=<?php echo $s_no; ?>"><i class="fa fa-times" style="margin-left:170px;color:black"></i></a>
                    </div>
                    </div>
          ...
          <!--------------------------------###########################------------------------------------------->	
				    ...
				    <div class="col-sm-12">
                    <label class="col-sm-5 control-label" style="text-align:left;">Income Account</label>
                    <div class="col-sm-7">
                    ...
                    <div class="col-sm-7">
						...
						<?php
						$que12="select * from contact_master where s_no='$customer_id' and company_code='$company_code' and company_code='$company_code'";
					...
					<div class="form-group" id="cheque_or_dd" style="display:none">
				    <div class="col-sm-12">
                    <label class="col-sm-5 control-label" style="text-align:left;">Cheque/DD</label>
                    <div class="col-sm-7">
                      <select class="form-control select2" name="cheque_or_dd" id="cheque_or_dd1" style="width:100%">

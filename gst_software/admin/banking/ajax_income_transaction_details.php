...
include("../../attachment/session.php");
    ...
    values('$s_no','$customer_id','$date','$invoice_total_paid','$reference','$payment_mode','$cheque_dd','$cheque_dd_no','$cheque_dd_issue_date','$cheque_dd_clearing_date','$remark','Credit','$upload_file','$folder_id','$bank_account_type','$bank_name','$invoice_no','$invoice_balance','$cheque_status')";

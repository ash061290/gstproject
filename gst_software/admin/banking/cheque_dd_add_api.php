...
include("../../attachment/image_compression_upload.php");
	...
	$quer="insert into account_info(bank_s_no,customer_id,date,invoice_total_paid,reference,payment_mode,cheque_dd,cheque_dd_no,cheque_dd_issue_date,cheque_dd_clearing_date,remark,transaction_type,upload_file,folder_name,account_type,account_name,invoice_no,invoice_due_amount,company_name,company_code)
    values('$bank_s_no','$customer_id','$date','$invoice_total_paid','$reference','$cheque_dd','$cheque_dd','$cheque_dd_no','$cheque_dd_issue_date','$cheque_dd_clearing_date','$remark','$cheque_transaction_type','','','$bank_account_type','$bank_name','$invoice_no','$invoice_balance','$company_name','$company_code')";

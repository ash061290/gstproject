...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('sales/new_invoice')"><i class="fa fa-plus"></i>Add New </a></li>
        <li class="active">Sales recycle</li>
      </ol>
    </section>
<script>
function valid(s_no){ 
...
$.ajax({
type: "POST",
url: software_link+"recycle/sales_invoice_permanent_delete_api.php",
data: "id="+s_no,
cache: false,
...
$.ajax({
type: "POST",
url: software_link+"recycle/restore_sales_invoice_api.php",
data: "id="+s_no,
cache: false,
success: function(detail){
    var res=detail.split("|?|");
...
<section class="content">
      <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#security" data-toggle="tab" style="font-size:15px;">Sales Invoice</a>
                                </li>
								                <li ><a href="#home" data-toggle="tab" style="font-size:15px;">Sales order</a>
                                </li>
                                <li><a href="#messages" data-toggle="tab" style="font-size:15px;">Sales payment</a>
                                </li>
                            </ul>
        ...
        $query ="select * from sales_invoice_new where invoice_status='Deleted'and company_code='$company_code'";

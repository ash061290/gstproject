...
$.ajax({
type: "POST",
url: software_link+"recycle/item_list_permanent_delete_api.php",
data: "id="+s_no,
cache: false,
...
if(myval==true){
restore_item_list(s_no);       
 }            
else  {      
return false;
  }       
} 
  function restore_item_list(s_no){
$.ajax({
type: "POST",
url: software_link+"recycle/restore_item_list_api.php",
data: "id="+s_no,
cache: false,
success: function(detail){
    var res=detail.split("|?|");
          ...
          <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
				...
				<tbody id="">
				<?php
				$que="select * from item where item_status='Deleted' and company_code='$company_code'";

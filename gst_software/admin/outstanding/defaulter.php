<?php  include("../../attachment/session.php"); ?>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li><a href="javascript:get_content('due_payment/receivable_payment')"><i class="fa fa-list"></i>Receivable Payment</a></li>
...
<script type="text/javascript">
	  ...
	  var to_date= document.getElementById('to_date').value;
	   $.ajax({
			  type: "POST",
              url: software_link+"due_payment/ajax_due_payment_date.php?default_from_date="+from_date+"&default_to_date="+to_date+"",
              cache: false,
	   ...
	   if(current_month=="all")
   {
    ...
    var to_date=current_year+'-12-31';
      $.ajax({
			  type: "POST",
              url: software_link+"due_payment/ajax_due_payment_all_month.php?credit_default_current_year="+current_year+"&from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
...
//ashish create
   ...
   else
   {
		 ...
		 $.ajax({
             type:"POST",		   
		     url: software_link+"due_payment/ajax_payterm_search.php?pay_term_default="+pay_term+"",
			 cache:false,

...
<script type="text/javascript">
	  ...
	  var to_date= document.getElementById('to_date').value;
	   $.ajax({
			  type: "POST",
              url: software_link+"due_payment/dashboard_date_ajax.php?from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
	  ...
	  if(current_month =='all')
   {
    ...
    var to_date=current_year+'-12-31';
      $.ajax({
			  type: "POST",
              url: software_link+"due_payment/dashboard_year_ajax.php?current_year="+current_year+"&from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
...
<script>
    function for_contact_area(value){
	  var contact_area = value;
	     $.ajax({
			  type: "POST",
              url: software_link+"due_payment/contact_area_ajax.php?contact_area="+contact_area+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
  ...
  <!-- small box -->
      <div class="small-box" style="padding:15px; background-color:#fff;">
        <a href="contact_type.php?contact_type=<?php echo $customer; ?>">
          <center><p><img src="../../documents/icon/user7.png" width="38px" height="38px" class="img-responsive" /></p></center>
...
<!-- ./col -->
  ...
  <!-- small box -->
        <div class="small-box" style="padding:15px; background-color:#fff;">
	        ...
	        <center><p><img src="../../documents/icon/user5.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
            <div class="small-box" style="padding:15px; background-color:#fff;">
               ...
               <center><p><img src="../../documents/icon/15.png" width="38px" height="38px" class="img-responsive" /></p></center>
               ...
               <div class="col-md-4 col-sm-4">
                    ...
                    <div class="small-box" style="padding:15px; background-color:#fff;">
	                  <a href="payment_term.php?pay_term=<?php echo $net_30; ?>">
                       <center><p><img src="../../documents/icon/30_2.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                   ...
                   <div class="small-box" style="padding:15px; background-color:#fff;">
                      <center><p><img src="../../documents/icon/45.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                     <a href="payment_term.php?pay_term=<?php echo $net_60; ?>">
                      <div class="small-box" style="padding:15px; background-color:#fff;">
                     <center><p><img src="../../documents/icon/60.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                  ...
                  <center><p><img src="../../documents/icon/31_1.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                    <div class="small-box" style="padding:15px; background-color:#fff;">
                      <a href="payment_term.php?pay_term=<?php echo $due_next_month; ?>">
                       <center><p><img src="../../documents/icon/31_3.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                         <div class="small-box" style="padding:15px; background-color:#fff;">
                           <a href="payment_term.php?pay_term=<?php echo $on_receipt; ?>">
                            <center><p><img src="../../documents/icon/31_4.png" width="38px" height="38px" class="img-responsive" /></p></center>
	...
	<div class="col-md-4 col-sm-4">
		 <div class="small-box" style="padding:15px; background-color:#fff;">
		  <a href="payable_payment.php">
			<center><p><img src="../../documents/icon/expence_logo.png" width="38px" height="38px" class="img-responsive" /></p></center>
...
<div class="col-md-4 col-sm-4">
		 <div class="small-box" style="padding:15px; background-color:#fff;">
		  <a href="receivable_payment.php">
			<center><p><img src="../../documents/icon/report.png" width="38px" height="38px" class="img-responsive" /></p></center>
		...
		<div class="col-md-4 col-sm-4 ">
			 <div class="small-box" style="padding:15px; background-color:#fff;">
			  ...
			  <center><p><img src="../../documents/icon/block.png" width="38px" height="38px" class="img-responsive" /></p></center>

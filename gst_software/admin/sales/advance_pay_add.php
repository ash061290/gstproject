...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascrip:get_content('index')"><i class="fa fa-home"></i>Home</a></li>
        ...
        <!--------------------------------###########################------------------------------------------->	        			
			    ...
			    <div class="col-sm-12 form-horizontal">	
                    ...
                    <div class="col-sm-7">
						...
						<option value="">Select</option>
						<?php
						  $select_advance_sales = "select * from sales_invoice_info where invoice_status='Active' and advance_no!='' and invoice_due_amount>0 and company_code='$company_code'";
	       ...
	       <!-----------------------------------Expence Details Start----------------------------------->		   
				...
				<tbody>				
				<?php				
				$que="select * from sales_invoice_info where advance_no!='' and invoice_due_amount !='0' and invoice_status='Active' and company_code='$company_code'";
				$run=mysql_query($que);
				while($row=mysql_fetch_array($run)){
...
<?php
	...
	$quer1="update invoice_no set folder_id='$folder_id' where company_code='$company_code' and company_code='$company_code'";
	mysql_query($quer1);
	if($invoice_no1!=''){

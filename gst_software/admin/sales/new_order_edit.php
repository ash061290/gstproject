...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	$("#sales_order_edit_form").submit(function(e){
        e.preventDefault();
       var formdata = new FormData(this);
        $.ajax({
            url: software_link+"sales/sales_order_edit_api.php",			
            type: "POST",
            data: formdata,
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-plus"></i> Add Order</a></li>
        <li class="active"><i class="fa fa-pencil"></i> Edit Order</a></li>
      </ol>
    </section>
	<?php
	...
	while($row11=mysql_fetch_array($run11)){
			...
			$delivery_method = $row11['delivery_method'];
	...
	?>
    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="sales_order_edit_form" enctype="multipart/form-data">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title" style="color:red">Order</h1>
			   <h1 class="box-title" style="float:right;">Sales Order No: <?php echo $invoice_no; ?></h1>
            </div>
            <!-- /.box-header -->
<!------------------------------------------------Start Registration form--------------------------------------------------->
	<div class="box-body">
	            <div class="col-md-12">
					<input style="display:none;" type="radio" name="invoice_type" id="inv_type_2" value="sales" <?php if($order_type=='sales'){ echo 'checked'; }else{ echo 'disabled'; } ?> >
					...
					<br><br>
					<a href="../contact/contact.php?invoice_edit=new_order_edit&order_no=<?php echo $order_no; ?>&order_type=<?php echo $order_type; ?>"><button type="button" style="background-color:#00a65a; color:white" class="">+ New Contact</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<input type="date" name="invoice_due_date" id="due_date" value="<?php echo $invoice_due_date; ?>"  class="form-control">
					...
					<div class="form-group col-md-4" >
					  ...
					  <input type="tax" name="delivery_method" placeholder="Delivery Method" value="<?php echo $delivery_method; ?>" class="form-control">
					</div>
				</div>
				<div class="col-md-12 ">
		<div class="form-group col-md-4">		
				...
				<div class="col-md-12 ">
               	<div class="form-group col-md-4">
					...
					<div class="form-group col-md-4" >
					  ...
					  <input type="tax" name="sales_person_name" placeholder="Sales Person Name" value="<?php echo $sales_person_name; ?>" class="form-control">
					</div>
					<div class="form-group col-md-4" >
					  <label>Sales Excutive Name</label>
					  <input type="tax" name="sales_excutive_name" placeholder="Sales Excutive Name" value="<?php echo $sales_excutive_name; ?>"  class="form-control">
					</div>
				</div>
...
echo "<script>window.open('../contact/contact_edit.php?id=$invoice_firm_name&page=new_order_edit&order_no=$order_no&order_type=$order_type','_self');</script>";
} ?>

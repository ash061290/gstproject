...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	$("#sales_new_estimate_form").submit(function(e){
       ...
       var formdata = new FormData(this);
        $.ajax({
            url: software_link+"sales/new_delivery_challan_api.php",			
            type: "POST",
            data: formdata,
  ...
  <script src="../attachment/file_check.js"></script>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-dashboard"></i>Home</a></li>
         <li><a href="javascript:get_content('sales/sales_delivery_challan_list')"><i class="fa fa-shopping-cart"></i>Sales Delivery</a></li>
    ...
    <input type="hidden" name="sales_challan_no" value="<?php echo $delivery_challan_no; ?>" />
    ...
    <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
			  ...
			  <h1 class="box-title" style="float:right;">Challan No: <?php echo 'DC-'.$val; ?></h1>
            </div>
	<div class="box-body">
	<div class="col-md-12">
	<div class="row">

...
$select ="select * from $table_name where invoice_no='$challan_no' and company_code='$company_code'";
$run = mysql_query($select);
$numrow = mysql_num_rows($run);
if($numrow<1){
	$query="update $table_name2 set invoice_status='Deleted' where invoice_no='$challan_no' and company_code='$company_code'";
}
else{
	$query="update $table_name set invoice_status='Deleted' where invoice_no='$challan_no and company_code='$company_code''";
}

...
$company_code = $_GET['company_code'];
 $query="select * from contact_master where s_no='$id' and company_code='$company_code'";
...
echo $contact_gstin."|?|".$contact_place_of_supply."|?|".$contact_shipping_address." ".$contact_shipping_city." ".$contact_shipping_state." (".$contact_shipping_zipcode.") ".$contact_shipping_country."|?|".$contact_company_name."|?|".$payment_term."|?|".$contact_transport_name;
}
?>
...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	$("#sales_delivery_challan_edit_form").submit(function(e){
        e.preventDefault();
       var formdata = new FormData(this);
        $.ajax({
            url: software_link+"sales/new_delivery_challan_edit_api.php",			
            type: "POST",
            data: formdata,
            ...
            success: function(detail){
			   ...
			   if(res[1]=='success'){
				   ...
				   post_content('sales/sales_delivery_challan_list',res[2]);
            }
			}
         });
      });
   ...
   <script type="text/javascript">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-plus"></i> Add Delivery Challan</a></li>
        <li class="active"><i class="fa fa-pencil"></i> Edit Delivery Challan</a></li>
      </ol>
    </section>
	<?php
	...
	$number=0;
	if($num<1){
	$que11="select * from $table_name2 where invoice_no='$challan_no' and invoice_status='Active' and company_code='$company_code'";
	$run11 = mysql_query($que11) or die(mysql_error());
	$number=1;
	}
	...
	?>
    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="sales_delivery_challan_edit_form" enctype="multipart/form-data">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title" style="color:red">Delivery Challan</h1>
			   <h1 class="box-title" style="float:right;">Delivery No: <?php echo $invoice_no; ?></h1>
            </div>
            <!-- /.box-header -->
<!------------------------------------------------Start Registration form--------------------------------------------------->
	<div class="box-body">
			...
			<div class="form-group col-md-4" >
					  ...
					  <option value="">Select Firm</option>
							...
							$qry2 = "select * from contact_master where s_no='$invoice_firm_name' and company_code='$company_code'";
							$rest2 = mysql_query($qry2);
							if($row12 = mysql_fetch_array($rest2)){
							    $contact_payment_terms =$row12['contact_payment_terms'];
							}
					...
					<br><br>
					<a href="../contact/contact.php?invoice_edit=new_delivery_challan_edit&challan_no=<?php echo $challan_no; ?>&challan_type=<?php echo $challan_type; ?>"><button type="button" style="background-color:#00a65a; color:white" class="">+ New Contact</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="form-group col-md-4" >
					  ...
					  <input type="date" name="invoice_date" placeholder="Date" id="invoice_date" value="<?php echo $invoice_date; ?>" class="form-control">
					</div>
	...
	if($num12<1)
	{
		 ...
		 $run12 = mysql_query($que12);
			...
			$sql2 = "select item_mrp_price from item_master join sales_delivery_challan_info on item_master.s_no=sales_delivery_challan_info.invoice_product_name where sales_delivery_challan_info.s_no='$invoice_s_no'";

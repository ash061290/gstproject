...
for(i=1; i<sno; i++){
  ...
  <div class="content-wrapper"> 
	...
	$table_name='recuring_invoice_info';
	...
	if($num12<1)
	{
		 ...
		 $run12 = mysql_query($que12);
			...
			$invoice_total=$row12['invoice_total'];
			 $sql2 = "select item_mrp_price from item_master join recuring_invoice_info on item_master.s_no=recuring_invoice_info.invoice_product_name where recuring_invoice_info.s_no='$invoice_s_no'";
        ...
        <table class="table table-bordered" style="background-color:white;" id="table_1">
			...
			<tbody><tr><th style="width:70px;">MRP</th>
...
echo "<script>window.open('../contact/contact_edit.php?id=$invoice_firm_name&page=recuring_invoice_edit&invoice_no=$invoice_no&invoice_type=$invoice_type','_self');</script>";
}

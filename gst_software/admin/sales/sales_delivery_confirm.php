...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	$("#sales_delivery_confirm_form").submit(function(e){
        e.preventDefault();
       var formdata = new FormData(this);
        $.ajax({
            url: software_link+"sales/sales_delivery_confirm_api.php",			
            type: "POST",
            data: formdata,
   ...
   <script type="text/javascript">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('sales/sales_delivery_challan_list')"><i class="fa fa-plus"></i>Sales Delivery Challan</a></li>
        <li class="active"><i class="fa fa-pencil"></i> Delivery Challan</a></li>
      </ol>
    </section>	
	<?php
	...
	<?php
						...
						?>
    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="sales_delivery_confirm_form" enctype="multipart/form-data">
    <section class="content">
	 <input type="hidden" name="challan_no" placeholder="" value="<?php echo $invoice_no; ?>" class="form-control" readonly>
	 <input type="hidden" name="invoice_no" placeholder="" value="<?php echo 'INV-'.$val; ?>" class="form-control" readonly>
	 <input type="hidden" name="sales_invoice_no" placeholder="" value="<?php echo $sales_invoice_no; ?>" class="form-control" readonly>
      <!-- Small boxes (Stat box) -->
      <div class="row">
	       <!-- general form elements disabled -->
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title" style="color:red">Delivery Challan To Invoice</h1>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
	<div class="box-body">
				...
				<div class="col-md-12 ">	
                  ...
                  <!-- /.box-header -->
    <div class="box-body table-responsive" id="tab_div">

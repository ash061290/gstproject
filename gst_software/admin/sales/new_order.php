    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-dashboard"></i>Home</a></li>
         <li><a href="javascript:get_content('sales/sales_order_list')"><i class="fa fa-shopping-cart"></i>Sales Order</a></li>
        <li class="active">Add Sales Order</li>
      </ol>
    </section>

    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="sales_new_order_form" enctype="multipart/form-data">
	              ...
	              <div class="form-group col-lg-4">
					...
					<div class="form-group col-lg-4">
					  <label>Transport Name</label>
						   <input type="text" name="invoice_transport" id="transport_name" placeholder="Add Transport" value="" class="form-control">
					</div>
					<div class="form-group col-lg-4">

...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	$("#new_recuring_invoice_form").submit(function(e){
        e.preventDefault();
       var formdata = new FormData(this);
        $.ajax({
            url: software_link+"sales/new_recuring_invoice_api.php",			
            type: "POST",
            data: formdata,
            ...
            success: function(detail){
			   ...
			   if(res[1]=='success'){
				   ...
				   post_content('sales/recuring_invoice',res[2]);
            }
			}
         });
      });   
<?php
						...
						$recuring_no=$row2['recuring_no'];
						$val=substr($recuring_no, 1);
						}
						?>
  </script>
  <script src="../attachment/file_check.js"></script>
    ...
    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="new_recuring_invoice_form" enctype="multipart/form-data">
	<input type="hidden" name="recuring_no" value="<?php echo $recuring_no; ?>" />
	<input type="hidden" name="invoice_no" value="<?php echo 'REC-'.$val; ?>" />
    ...
    <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title" style="color:red">Recuring Invoice</h1>
			  <h1 class="box-title" style="float:right;">Invoice No: <?php echo 'REC-'.$val; ?></h1>
            </div>
	<div class="box-body">
	<div class="col-md-12">
	<div class="row">
	          ...
	          <div class="col-md-12">
				...
				<div class="form-group col-lg-4">
					 <label >Billing Address</label>
						<textarea name="invoice_billing_address" id="invoice_billing_address" rows="3" class="form-control" style="resize:none;"></textarea><br/>
						</div>
					</div>
				</div>
				<div class="col-md-12">

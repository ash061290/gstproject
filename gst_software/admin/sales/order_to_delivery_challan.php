<?php include("../../attachment/session.php"); ?>
  ...
  $.ajax({
			address: "POST",
			url: software_link+"sales/ajax_get_item_description.php?value="+value+"&company_code="+company_code+"",
			cache: false,
   ...
   <script type="text/javascript">
     $( document ).ready(function() {
	     ...
	     payment_term2(pay_term_value);
	   	...
	   	$("#order_to_delivery_form").submit(function(e){
        e.preventDefault();
    var formdata = new FormData(this);
        $.ajax({
            url: software_link+"sales/order_to_delivery_challan_api.php",			
            type: "POST",
            data: formdata,
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('sales/new_delivery_challan')"><i class="fa fa-plus"></i> Add Delivery Challan</a></li>
        <li class="active"><i class="fa fa-plus"></i> Create Delivery Challan</a></li>
      </ol>
    </section>
	<?php
	$order_no=$_GET['order_no'];
	$invoice_no1 = $order_no;
	...
	while($row11=mysql_fetch_array($run11)){
			...
			$invoice_order_no2=$row11['invoice_order_no'];
    ...
    <section class="content">
      ...
      <div class="row">
	    <div class="col-xs-12">
		   <form method="post" onsubmit="return validate();" id="order_to_delivery_form" enctype="multipart/form-data">
		   <input type="hidden" name="invoice_order_no" value="<?php echo $invoice_order_no; ?>">
	<input type="hidden" name="invoice_no" value="<?php echo 'DC-'.$val; ?>" />
	<input type="hidden" name="delivery_challan_no" value="<?php echo $delivery_challan_no; ?>" />
          <div class="box">
            <div class="box-header with-border ">
              <h1 class="box-title" style="color:red">Delivery Challan</h1>
			 <h1 class="box-title" style="float:right;">Delivery No: <?php echo 'DC-'.$val; ?></h1>
            </div>
	<div class="box-body">
			 <div class="row">
              <div class="col-md-12">
					...
					<br><br>
					<a href="javascript:get_content('contact/contact','invoice_edit=new_invoice_edit&invoice_no=<?php echo $invoice_no; ?>&invoice_type=<?php echo $invoice_type; ?>')"><button type="button" style="background-color:#00a65a; color:white" class="">+ New Contact</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<?php
			...
			$sql2 = "select item_mrp_price from item_master join sales_order_info on item_master.s_no=sales_order_info.invoice_product_name where sales_order_info.s_no='$invoice_s_no'";
			 ...
			 <tr id="<?php echo 'row_'.$serial; ?>">
					...
					<td>
					 <div class="form-group">
							...
							<?php
						$qry="select * from item_master where company_code='$company_code' and item_status='Active'";
							$res=mysql_query($qry);
							while($row=mysql_fetch_array($res)){
							$s_no=$row['s_no'];
							echo $item_product_name=$row['item_product_name'];

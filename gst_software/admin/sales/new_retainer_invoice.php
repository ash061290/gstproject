...
$.ajax({
  ...
  function payment_detail(value,company_code){
  if(value!=''){
	$.ajax({
		address: "POST",
		url: software_link+"sales/get_payment_details.php?id="+value+"&company_code="+company_code+"",
		cache: false,
		success: function(detail){
		var res = detail.split("|?|");
		var myvar=res[0];
...
<?php
						...
						$retainer_invoice_no=$row2['retainer_invoice_no'];
						$val=substr($retainer_invoice_no, 1);
						}
						?>
  </script>
  <script src="../attachment/file_check.js"></script>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-dashboard"></i>Home</a></li>
         <li><a href="javascript:get_content('sales/recuring_invoice')"><i class="fa fa-shopping-cart"></i>Recuring Invoice</a></li>
        <li class="active">Add Delivery</li>
      </ol>
    </section>

    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="sales_new_estimate_form" enctype="multipart/form-data">
    ...
    <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title" style="color:red">Retainer Invoice</h1>
			  <h1 class="box-title" style="float:right;">Invoice No: <?php echo 'RET-'.$val; ?></h1>
            </div>
	<div class="box-body">
	<div class="col-md-12">
	<div class="row">
	<div class="form-group col-lg-4">
					...
					<a href="javascript:post_content('contact/contact','invoice=new_invoice')"><button type="button" style="background-color:#00a65a; color:white" class="">+ New Contact</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"><button onclick="edit_firm();" style="background-color:#00a65a; color:white;" class="">Edit Firm</button></a>
					 </div><br/><br/>
					  ...
					  <input type="hidden" name="invoice_no" placeholder="" value="<?php echo 'EST-'.$val; ?>" class="form-control" readonly>
					  <div class="form-group col-lg-4">
					...
					<div class="form-group col-lg-4">
					 <label>Payment Term</label>
					  <input type="text" name="payment_term" id="pay_term" placeholder="Pay Term" value="" class="form-control" readonly>
					</div>
			  </div>
			     </div>
	          <div class="col-md-12">
	              ...
	              <div class="form-group col-lg-4">
					 <label>Expiry Date</label>
					  <input type="date" name="invoice_due_date" placeholder="Date" value="" class="form-control" id="due_date">
					</div>
				...
				<div class="form-group col-lg-4" >
					...
					<div class="form-group col-md-4" >
					  ...
					  <select name="challan_type" class="form-control select2">
					      <option value="marketing service">Marketing Services</option>
						  <option value="excutive service">Executive Services</option>
						  <option value="Other">Other Services</option>
					   </select>
					</div>
				<div class="form-group col-md-4">
						  <label>Sales Person</label>
						   <input type="text" name="invoice_sales_person" placeholder="Add Sales Person" value="" class="form-control">
						</div>
					</div>
				</div>
				<div class="col-md-12">
				<div class ="row">
				<div class="form-group col-md-4">
						  <label>Sales Excutive</label>
						   <input type="text" name="invoice_sales_excutive" placeholder="Add Sales Executive" value="" class="form-control">
						</div>
				<div class="form-group col-lg-4">
					 <label >Billing Address</label>
						<textarea name="invoice_billing_address" id="invoice_billing_address" rows="2" class="form-control"></textarea><br/>
						</div>
						<div class="form-group col-lg-4">
						<label>Shipping Address</label>
						<textarea name="invoice_shipping_address" id="invoice_shipping_address" rows="2" class="form-control"></textarea>
					</div>

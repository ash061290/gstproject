...
$que4="update $table_name invoice_status='deleted' where s_no='$invoice_delete_items1[$a]' and company_code='$company_code'";
mysql_query($que4);
}
}

...
for(i=1; i<sno; i++){
  if(value==res[1]){
	...
	function get_barcode(value,id,company_code){
       $.ajax({
		...
		$("#sales_new_estimate_form").submit(function(e){
        e.preventDefault();
    var formdata = new FormData(this);
        $.ajax({
            url: software_link+"sales/new_estimate_api.php",			
            type: "POST",
            data: formdata,
  ...
  <?php
				...
				$sales_estimate_no=$row2['sales_estimate_no'];
				$val=substr($sales_estimate_no, 1);
				}
				?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-dashboard"></i>Home</a></li>
         <li><a href="javascript:get_content('sales/sales_estimate_list')"><i class="fa fa-shopping-cart"></i>Sales Estimate</a></li>
	...
	<input type="hidden" name="invoice_no" value="<?php echo 'EST-'.$val; ?>" />
	<input type="hidden" name="sales_estimate_no" value="<?php echo $sales_estimate_no; ?>" />
    ...
    <div class="box box-primary my_border_top">
            <div class="box-header with-border">
			  ...
			  <h1 class="box-title" style="float:right;">Estimate No: <?php echo 'EST-'.$val; ?></h1>
            </div>	
	<div class="box-body">
	<div class="col-md-12">
	<div class="row">
				...
				<div class="form-group col-lg-4" >
					...
					<div class="form-group col-lg-4">
					 <label >Billing Address</label>
						<textarea name="invoice_billing_address" id="invoice_billing_address" style="resize:none;" rows="2" class="form-control"></textarea><br/>
						</div>
						<div class="form-group col-lg-4">
						<label>Shipping Address</label>
						<textarea name="invoice_shipping_address" id="invoice_shipping_address" style="resize:none;" rows="2" class="form-control"></textarea>
					</div>
					</div>
			 ...
			 <tr>
					...
					<input type="text" name="barcode_no" placeholder="Scan Item" onblur="get_barcode(this.value,1,'<?php echo $company_code; ?>');" value="" class="form-control">
						...
						<div>
							...
							<textarea name="item_description[]" id="desc_1" class="form-control" style="display:none;border-color:Transparent;padding:0px;margin:0px; resize:none;" rows="1" ></textarea>
						</div>
					</td>
					<td>

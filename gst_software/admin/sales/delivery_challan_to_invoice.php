...
<!--end firm-->	
  ...
  <script src="../attachment/file_check.js"></script>
	...
	?>
    <!-- Main content -->
	<form method="post" onsubmit="return validate();" id="delivery_challan_to_invoice_form" enctype="multipart/form-data">
	...
	<div class="box-body">
				...
				<div class="col-lg-12">
					<div class="form-group col-lg-5">
					 ...
					 <input type="text" name="sales_person_name" class="form-control" placeholder="Sales Person Name" required />
				...
				<div class="col-lg-12">
					<div class="form-group col-lg-5">
					 <label >Transport Name</label>
					  <input type="text" name="transport_name" placeholder="Transport Name" id="transport_name" value="" class="form-control" required>
					</div>
				</div>
				<div class="col-lg-12">
					<div class="form-group col-lg-5">
	...
	if($num12<1)
	{
		 $que12 = "select * from $table_name2 where invoice_no='$challan_no' and invoice_status='Active' and company_code='$company_code'";
...
if($number==1){
	$qry6 = "update $table_name2 set invoice_quantity='$item_quantity[$j]',invoice_available_quantity='$stock_item_quantity' where invoice_no='$challan_no' and company_code='$company_code'";
}
mysql_query($qry6);
mysql_query($que5);
} }
...
if($set>0){
  ...
  $update_sales_delivery = "update sales_delivery_challan_info set invoice_status2='Invoiced' where invoice_no='$challan_no' and company_code='$company_code'";
	 ...
	 if($number==1){
		  $update_sales_delivery = "update $table_name2 set invoice_status2='Invoiced' where invoice_no='$challan_no' and company_code='$company_code'";
	 }
 ...
 $select_sales_order = "select order_no from sales_delivery_challan_info where invoice_no='$challan_no' and company_code='$company_code'";
   ...
   if($number==1){
	    $select_sales_order = "select order_no from $table_name2 where invoice_no='$challan_no' and company_code='$company_code'";
   }

...
<!--box-->
<div class="box">
  <div class="col-md-4 col-sm-4" style="background-color:#EFF4F2;">
    <div class="col-md-4 col-sm-4">
  <!-- small box -->
      <div class="small-box" style="padding:15px; background-color:#fff;">
        <a href="javascript:post_content('reminder/contact_type','contact_type=<?php echo $customer; ?>')">
          <center><p><img src="<?php echo $image_path; ?>user7.png" width="38px" height="38px" class="img-responsive" /></p></center>
...
<!-- ./col -->
  ...
  <!-- small box -->
        <div class="small-box" style="padding:15px; background-color:#fff;">
                 <a href="javascript:post_content('reminder/contact_type','contact_type=<?php echo $vendor; ?>')">
	        <center><p><img src="<?php echo $image_path; ?>user5.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
            <div class="small-box" style="padding:15px; background-color:#fff;">
	            <a href="javascript:post_content('reminder/payment_term','pay_term=<?php echo $net_15; ?>')">
               <center><p><img src="<?php echo $image_path; ?>15.png" width="38px" height="38px" class="img-responsive" /></p></center>
               ...
               <div class="col-md-4 col-sm-4">
                     <!-- small box -->
                    <div class="small-box" style="padding:15px; background-color:#fff;">
	                  <a href="javascript:post_content('reminder/payment_term','pay_term=<?php echo $net_30; ?>')">
                       <center><p><img src="<?php echo $image_path; ?>30_2.png" width="38px" height="38px" class="img-responsive" /></p></center>
                        <center><p><span style="color:green;">NET-30</span></p></center></a>
                       </div>
                          </div>
                <div class="col-md-4 col-sm-4">
  <!-- small box -->
                   <a href="javascript:post_content('reminder/payment_term','pay_term=<?php echo $net_45; ?>')">
                   <div class="small-box" style="padding:15px; background-color:#fff;">
                      <center><p><img src="<?php echo $image_path; ?>45.png" width="38px" height="38px" class="img-responsive" /></p></center>
                       <center><p><span style="color:green;">NET-45</span></p></center></a>
                     </div>
                        </div>
             <div class="col-md-4 col-sm-4">
  <!-- small box -->
                     <a href="javascript:post_content('reminder/payment_term','pay_term=<?php echo $net_60; ?>')">
                      <div class="small-box" style="padding:15px; background-color:#fff;">
                     <center><p><img src="<?php echo $image_path; ?>60.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                    <div class="small-box" style="padding:15px; background-color:#fff;">
	                    <a href="javascript:post_content('reminder/payment_term','pay_term=<?php echo $due_end_month; ?>')">
                  <center><p><img src="<?php echo $image_path; ?>31_1.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                    <div class="small-box" style="padding:15px; background-color:#fff;">
                      <a href="javascript:post_content('reminder/payment_term','pay_term=<?php echo $due_next_month; ?>')">
                       <center><p><img src="<?php echo $image_path; ?>31_3.png" width="38px" height="38px" class="img-responsive" /></p></center>
  ...
  <!-- small box -->
                         <div class="small-box" style="padding:15px; background-color:#fff;">
                           <a href="javascript:post_content('reminder/payment_term','pay_term=<?php echo $on_receipt; ?>')">
                            <center><p><img src="<?php echo $image_path; ?>31_4.png" width="38px" height="38px" class="img-responsive" /></p></center>
                            <center><p><span style="color:green; ">ON RECEIPT</span></p></center></a>
                                </div>
                                    </div>
	<div class="col-md-4 col-sm-4">
		 <div class="small-box" style="padding:15px; background-color:#fff;">
		  <a href="javascript:get_content('reminder/payable_payment')">
			<center><p><img src="<?php echo $image_path; ?>expence_logo.png" width="38px" height="38px" class="img-responsive" /></p></center>
...
<div class="col-md-4 col-sm-4">
		 <div class="small-box" style="padding:15px; background-color:#fff;">
		  <a href="javascript:get_content('reminder/receivable_payment')">
			<center><p><img src="<?php echo $image_path; ?>report.png" width="38px" height="38px" class="img-responsive" /></p></center>
		...
		<div class="col-md-4 col-sm-4 ">
			 <div class="small-box" style="padding:15px; background-color:#fff;">
			  <a href="javascript:get_content('reminder/defaulter')">
			  <center><p><img src="<?php echo $image_path; ?>block.png" width="38px" height="38px" class="img-responsive" /></p></center>

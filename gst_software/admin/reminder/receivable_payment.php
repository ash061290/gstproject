<?php include("../../attachment/session.php");?>
    ...
    <section class="content-header">
      <h1>
	   ...
	   <small>Receivable Payment</small>
      </h1>
      <ol class="breadcrumb">
		...
		<li><a href="javascript:get_content('reminder/defaulter')"><i class="fa fa-list"></i>Default Payment</a></li>
...
<script type="text/javascript">
	  ...
	  $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_reminder_date.php?credit_from_date="+from_date+"&credit_to_date="+to_date+"",
              cache: false,
	  ...
	  if(current_month =='all')
   {
      ...
      $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_reminder_all_month.php?credit_current_year="+current_year+"&from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
...
//ashish create
   ...
   else
   {
		 $.ajax({
             type:"POST",		   
		     url: software_link+"reminder/ajax_payterm_search.php?pay_term_credit="+pay_term+"",
			 cache:false,
			 data:"pay_term_credit="+pay_term,
			 success: function(detail){ 
            $('#my_table1').html(detail);
              }
...
<div class="col-md-2 ">
 ...
 <select name="contact_payment_terms" class="form-control" class="select2" onchange="pay_term(this.value)" style="width:100%">

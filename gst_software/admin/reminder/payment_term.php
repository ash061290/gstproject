...
<script>
   ...
   else
   {
		 $.ajax({
             type:"POST",		   
		     url: software_link+"reminder/ajax_search_payment_term.php?pay_term="+pay_term+"",
			 cache:false,
...
<script type="text/javascript">
	  ...
	  var to_date= document.getElementById('to_date').value;
	   ...
	   $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_search_payment_term.php?from_date="+from_date+"&to_date="+to_date+"&payment_term="+payment_term+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
      ...
      $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_search_payment_term.php?current_year="+current_year+"&payment_term="+payment_term+"&from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }

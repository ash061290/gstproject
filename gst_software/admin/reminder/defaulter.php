<?php  include("../../attachment/session.php"); ?>
    <section class="content-header">
      <h1>
	   ...
	   <small>Default Payment</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index')"><i class="fa fa-home"></i>Home</a></li>
		 <!--<li><a href="reminder.php"><i class="fa fa-list"></i>All Due Transaction</a></li>-->
		<li><a href="javascript:get_content('reminder/receivable_payment')"><i class="fa fa-list"></i>Receivable Payment</a></li>
...
<script type="text/javascript">
	  ...
	  var to_date= document.getElementById('to_date').value;
	   $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_reminder_date.php?default_from_date="+from_date+"&default_to_date="+to_date+"",
              cache: false,
	   ...
	   if(current_month=="all")
   {
    ...
    var to_date=current_year+'-12-31';
      $.ajax({
			  type: "POST",
              url: software_link+"reminder/ajax_reminder_all_month.php?credit_default_current_year="+current_year+"&from_date="+from_date+"&to_date="+to_date+"",
              cache: false,
              success: function(detail){
              $('#my_table1').html(detail);
              }
...
//ashish create
   ...
   else
   {
		 ...
		 $.ajax({
             type:"POST",		   
		     url: software_link+"reminder/ajax_payterm_search.php?pay_term_default="+pay_term+"",
			 cache:false,
			 data:"pay_term_default="+pay_term,
			 success: function(detail){ 
            $('#my_table1').html(detail);
              }

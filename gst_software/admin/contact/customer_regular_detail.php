...
function for_print()
 {
	...
	$.ajax({
		method:"POST",
		url:software_link+"contact/ajax_customer_payment_detail_print.php",
		data:"from_date="+from_date+"&to_date="+to_date+"&s_no="+s_no,
		success:function(detail){
			//console.log(detail);
			$("#sample2").html(detail);
...
function exportTableToExcel(tableID, filename = ''){
    ...
    <div class="box my_border_top">
	     	<div class="col-sm-12">
			<div class="col-sm-4">
                <h4><i class="<?php echo $class ?>">&nbsp;<?php echo $customer_name."[".$customer_mobile."]"; ?></i></h4>
                <h5><strong>Total Payment :</strong> <b><a style="color:#0D0F2B;"><?php echo $total_amount; ?></a></b></h5>
            </div>
			<div class="col-md-5">
			 <div class="col-md-6">
			 <br/>
